    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by Nandhini E</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ph2{
            background-image: url(/static/images/vi.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
...
<html lang="en">
    <head>
        ...
        .manph2{
            background-image: url(/static/images/jk.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/th.png);
            background-size: 250px;
            background-position-x:center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Nandhini E</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="right"><b><h2>a1</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p align="left"><b><h2></h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="right"><b><h2>p2</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>p3</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="left"><b><h2>p4</h2></b></p></div><br>
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by Nandhini</footer></div>
            </div>
        </div>
    </body>
</html>
...
## HTML VALIDATOR:
![Screenshot (56)](https://github.com/Nandhinijaya/softweb/assets/121998147/144d33f7-1b01-4a86-8354-7ac90910d7f1)
